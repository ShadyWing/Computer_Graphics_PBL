#pragma once
//借鉴// Geometric Tools, LLC https://www.geometrictools.com/
//直线描述为参数方程 p + t*dir ；p为起点，dir为单位向量，t为实数
//空间中的一条直线
class my_3D_line
{
public:
...
public:
	IntersectionBetweenLineAndTriangle(const my_3D_line& line, const my_3D_triangle&
		triangle)
	{
		my_line = line;
